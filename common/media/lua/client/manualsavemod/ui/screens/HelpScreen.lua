...
local function start_lines()
    return {
        ...
        { "108600/3721602150/mods/ManualSaveMod/",                  "dim"       },
        { "",                                                                       },
        ...
        { "",                                                                       },
        { "3. Locate ManualSave_Watcher.cmd",                          "sub"       },
        { "ManualSave_Watcher.cmd   — the background process.",        "body"      },
        { "ManualSave_Screenshot.ps1 — used by the watcher.",          "body"      },
        { "",                                                                       },
        { "4. Start the Watcher",                                      "sub"       },
        { "Double-click ManualSave_Watcher.cmd.",                      "body"      },
        { "A PowerShell window opens — leave it running.",            "body"      },
        ...
        { "Red dot = .cmd is not running. Double-click it again.",     "warn"      },
        { "",                                                                       },
        { "FROM HERE",                                                 "header"    },
...
local function safety_lines()
    return {
        { "SHORT ANSWER",                                              "header"    },
        { "Yes. The mod ships open .ps1 and .cmd scripts,",            "body"      },
        ...
        { "Open ManualSave_Watcher.ps1 in Notepad.",                  "check"     },
        { "Open ManualSave_Screenshot.ps1 in Notepad.",               "check"     },
        { "Task Manager > Details: Watcher = powershell.exe",         "check"     },
        { "  with ManualSave_Watcher.ps1 in the command line.",        "dim"       },
        { "Resource Monitor > Network: no sockets opened.",           "check"     },
        { "",                                                                       },
        { "WHY ANTIVIRUS MAY FLAG IT",                                "header"    },
        { "Some AVs flag any unsigned .ps1 that calls",               "body"      },
        { "robocopy — a heuristic, not a real",                       "body"      },
...
local function watcher_what_lines()
    return {
        ...
        { "If you don't start the .cmd the mod is inert.",           "callout"   },
...
local function watcher_run_lines()
    return {
        ...
        { "3721602150\\mods\\ManualSaveMod\\",                    "body"      },
        { "ManualSave_Watcher.cmd   (launcher)",                      "sub"       },
        { "ManualSave_Watcher.ps1   (watcher logic)",                 "dim"       },
        ...
        { "Drop a shortcut to ManualSave_Watcher.cmd there.",        "body"      },
...
local function trouble_lines()
    return {
        ...
        { "Double-click ManualSave_Watcher.cmd.",                    "check"     },
        ...
        { "Double-click the .cmd again.",                            "check"     },
        { "",                                                                       },
        { "Other causes:",                                            "dim"       },
...
local function locations_lines()
    return {
        ...
        { "Steam/steamapps/workshop/content/108600/",                "body"      },
        { "3721602150/mods/ManualSaveMod/",                       "body"      },
        { "Top of that folder: Watcher.cmd, Watcher.ps1,",           "dim"       },
        { "mod.info.",                                                "dim"       },
        { "",                                                                       },
...
local function glossary_lines()
    return {
        ...
        { "",                                                                       },
        { "Watcher",                                                   "gloss_t"   },
        { "The external Windows process (Watcher.cmd/.ps1) that",    "gloss_d"   },
